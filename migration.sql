...
CREATE TABLE `bahan_praktik` (
  ...
  `stok` REAL DEFAULT NULL,
  `stok_min` REAL DEFAULT NULL,
...
CREATE TABLE `cbt_hasil` (
  ...
  `mulai` TEXT DEFAULT NULL,
  `selesai` TEXT DEFAULT NULL,
  `nilai_pg` REAL DEFAULT NULL,
  `nilai_essay` REAL DEFAULT NULL,
...
CREATE TABLE `cbt_jawaban` (
  ...
  `soal_id` INTEGER DEFAULT NULL,
  `jawaban` TEXT DEFAULT NULL,
  `benar` INTEGER DEFAULT NULL,
...
CREATE TABLE `cbt_sesi` (
  `id` INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
  `ujian_id` INTEGER DEFAULT NULL,
  `nis` TEXT DEFAULT NULL,
  `nama` TEXT DEFAULT NULL,
  `mulai` TEXT DEFAULT NULL,
  `deadline` TEXT DEFAULT NULL,
  `selesai` INTEGER DEFAULT 0,
  `skor` REAL DEFAULT NULL,
...
CREATE TABLE `cbt_soal` (
  `id` INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
  `ujian_id` INTEGER DEFAULT NULL,
  `no_urut` INTEGER DEFAULT NULL,
  `jenis` INTEGER DEFAULT NULL,
  `soal` TEXT DEFAULT NULL,
  `opsi` TEXT DEFAULT NULL,
  `kunci` TEXT DEFAULT NULL,
  `pembahasan` TEXT DEFAULT NULL,
...
CREATE TABLE `laporan_kerusakan` (
  ...
  `status` TEXT DEFAULT NULL,
  `jadwal_maintenance` TEXT DEFAULT NULL
);
...
CREATE TABLE `peminjaman` (
  `id` INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
  `id_pinjam` TEXT DEFAULT NULL,
  `kode_barang` TEXT DEFAULT NULL,
  `nama_barang` TEXT DEFAULT NULL,
  `peminjam` TEXT DEFAULT NULL,
  `jenis_peminjam` TEXT DEFAULT NULL,
  `tgl_pinjam` TEXT DEFAULT NULL,
  `batas_waktu` TEXT DEFAULT NULL,
  `status` TEXT DEFAULT NULL,
  `tgl_kembali` TEXT DEFAULT NULL
);
CREATE TABLE `pengumpulan` (
  `id` INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
  `tugas_id` INTEGER DEFAULT NULL,
  `nis` TEXT DEFAULT NULL,
  `file_url` TEXT DEFAULT NULL,
  `teks` TEXT DEFAULT NULL,
  `nilai` REAL DEFAULT NULL,
  `feedback` TEXT DEFAULT NULL,
  `tgl_kumpul` TEXT DEFAULT NULL
);
...
CREATE TABLE `siswa_meta` (
  ...
  `kontak_darurat` TEXT DEFAULT NULL,
...
CREATE TABLE `tugas` (
  ...
  `rubrik_id` INTEGER DEFAULT NULL
);
CREATE TABLE `users` (
  `id` INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
...
-- DATA
-- Cloudflare D1 / SQLite data converted from MySQL
...
(57, 'saskya', '$2y$10$AWWjc1.lv.dNhjeiCz5PYebSkz2D1gTSqQvSEep/PsnvGEvUFKSPm', 'Sekretaris', 'X PSPT', 'Saskya', ''),
